...
<table border="1">
	...
	<tr>
		...
		<td><input type="text" id="report" name="report" placeholder="Enter Query" required title="Enter Query string">
		</label></td>
		</td>
	</tr>
	...
	<tr>
		...
		<td align="center" colspan="2"><label><input type="submit" id="submit" name="query" value="GENERATE" required"></label></td>
