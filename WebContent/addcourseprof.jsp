		...
		<table border="1">
			<form name="addcourseprof" method="post" action="profaddcourse">
				<tr>
					...
					<td><input type="text" id="cid" name="cid"> </label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="cname" name="cname" placeholder=""
				...
				<tr>
					...
					<td><input type="text" id="clevel" name="clevel"
						placeholder="" required title="You can enter characters.">
						</label></td>
				</tr>
				<tr>
					<td><label><h4>Maximum Enrollment:</h4></td>
					<td><input type="text" id="menroll" name="menroll"
						placeholder="" required title="You can enter characters.">
						</label></td>
				</tr>
				<tr>
