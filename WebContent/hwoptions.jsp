...
session.setAttribute("hid", request.getParameter("hid"));
		...
		<%-- <%session.setAttribute("hid", request.getParameter("hid")); %> --%>
		<h4>
			Edit for HW<%=session.getAttribute("hid") %></h4>
		<br> <a href="<%=request.getContextPath()%>/searchaddqtn">Search
			and Add Questions</a>
		<!-- <a href="searchaddqtn.jsp">Search and Add Questions</a> -->
		<br> <a href="<%=request.getContextPath()%>/removeqtn">Remove
			Questions</a> <br> <a href="courseoptions.jsp">Back</a> <br>
	</div>
</body>
</html>