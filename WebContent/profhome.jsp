...
<ul class="tab">
	<li><a href="<%=request.getContextPath()%>/profhome.jsp"><span class="t">Home</span></a></li>
	<li><a href="<%=request.getContextPath()%>/selectcourseprof"><span class="t">Select Course</span></a></li>
	<li><a href="<%=request.getContextPath()%>/sendtextbook"><span class="t">Add Course</span></a></li>
...
<h4>Welcome Professor, <%=session.getAttribute("username") %></h4>
	...
	<a href="<%=request.getContextPath()%>/selectcourseprof">Select Course</a>
		...
		<a href="<%=request.getContextPath()%>/sendtextbook">Add Course</a>
		<br>
